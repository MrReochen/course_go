...
conf = {
    ...
    ### MODEL ###
    'N_RESIDUAL_BLOCKS': 5, # Size of the tower of residual blocks, 20 for small model, 40 for alphagozero full size
    ...
    ### SELF-PLAY ###
    'N_GAMES': 500,  # Number of games of self play generated by best_model, 25k in paper
    'MCTS_SIMULATIONS': 1024, # 1.6k in paper
    'SIZE': 8, # board size 19 in paper
    'KOMI': 0.75, # The komi points given to white player
    'STOP_EXPLORATION': 4, # Number of plays after which temperature goes to 0 , 30 in paper
    'MCTS_BATCH_SIZE': 64, # Size of the prediction batch while exploring mcts
